...
df_plot = df[df['pais'].str.upper() != "PROMEDIO GLOBAL"].sort_values('minutos_prom', ascending=False)

# === 7. Crear gráfico ===
plt.figure(figsize=(9, 5))
plt.bar(df_plot['pais'], df_plot['minutos_prom'], color='orange')

plt.title('Minutos diarios promedio en redes sociales (2025)')
...
for x, y in zip(df_plot['pais'], df_plot['minutos_prom']):
...
output_path = outdir / "minutos_diarios_promedio.png"
